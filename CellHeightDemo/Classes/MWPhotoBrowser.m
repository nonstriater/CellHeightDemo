...
- (UIImageView *)imageView{
    MWZoomingScrollView *scrollView = [_visiblePages anyObject];
    MWTapDetectingImageView *imageView = nil;
    for (UIView *view in scrollView.subviews) {
        if ([view isKindOfClass:[MWTapDetectingImageView class]]) {
            imageView = (MWTapDetectingImageView *)view;
        }
    }
    return imageView;
}
...
// UIPanGesture interactiveTransition
